...
public class emotion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getDate(getActivity(),"https://wx.idsbllp.cn/springtest/cyxbsMobile/index.php/QA/Question/getQuestionList","page=0&size=10&kind=情感",view);
        return view;
    }
    private void initview(final View view)
    {
        Log.d("emotion", "initview: "+questionList.get(0).getTitle()+"  "+questionList.get(1).getTitle());
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        page=0;
                        questionList.clear();
                        Http http=new Http("https://wx.idsbllp.cn/springtest/cyxbsMobile/index.php/QA/Question/getQuestionList","page="+page+"&size=10&kind=情感");
                        http.sendRequestWithHttpURLConnection(new Http.Callback() {
                            @Override
                            public void finish(String respone) {
                                parseJSON(respone);
