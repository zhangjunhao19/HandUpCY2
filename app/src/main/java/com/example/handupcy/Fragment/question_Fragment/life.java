...
public class life extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getDate(getActivity(),"https://wx.idsbllp.cn/springtest/cyxbsMobile/index.php/QA/Question/getQuestionList","page=0&size=10&kind=生活",view);
        return view;
    }
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        page=0;
                        questionList.clear();
                        Http http=new Http("https://wx.idsbllp.cn/springtest/cyxbsMobile/index.php/QA/Question/getQuestionList","page="+page+"&size=10&kind=生活");
                        http.sendRequestWithHttpURLConnection(new Http.Callback() {
                            @Override
                            public void finish(String respone) {
                                parseJSON(respone);
