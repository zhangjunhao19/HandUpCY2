...
public class all extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getDate(getActivity(),"https://wx.idsbllp.cn/springtest/cyxbsMobile/index.php/QA/Question/getQuestionList","page=0&size=10&kind=全部",view);
        return view;
    }
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(dy>0)
                {
                   // Log.d("上拉刷新", "onScrolled开始: ");
                    ...
                    if(listsize==questionList.size()){Toast.makeText(getActivity(),"垃圾图片加载库带不动了",Toast.LENGTH_SHORT).show();
                    }
                    }
                }
            }
    ...
    private void parseJSON(String respone) {
        try {
            ...
            Log.d("all", "parseJSON: "+respone);
            String result=jsonObject.getString("data");
            Log.d("难受呀马飞", "result "+result);
